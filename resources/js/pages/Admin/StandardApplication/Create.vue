    ...
    form.post(route('admin.standard-applications.store'), {
        ...
        onSuccess: () => {
            Swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'New standard added to the Regulatory & Industry Standards.',
        ...
        onError: () => {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
                text: 'Unable to add standard to the Regulatory & Industry Standards.',
...
<template>
    <AppLayout>
        <div class="p-6 w-full mx-auto">
            <!-- <h1 class="text-2xl font-bold mb-6">Add Regulatory & Industry Standards</h1> -->
            <div
