...
const trainingServices = services.filter(s => s.type.toLowerCase().includes('training'));
</script>
    ...
    <div class="flex flex-col min-h-screen bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <main class="flex-1 py-10 px-4 md:px-12">
            <div class="max-w-5xl mx-auto">
                <h1 class="text-3xl font-bold mb-8 text-blue-900 dark:text-white">Services (Training)</h1>
                <div class="grid md:grid-cols-2 gap-8">
                    <template v-for="service in trainingServices" :key="service.id">
